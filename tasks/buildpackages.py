...
def get_tag_branch_sha1(gitbuilder):
    ...
    problem with the install task because packaging._get_uri_reference
    is used to figure out what to install from the gitbuilder and this
    function gives priority to the tag, if not found the branch, if
    not found the sha1.
